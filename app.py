...
def main():
    ...
    st.title("Predicció del tipus d'estrella amb machine learning")
    ...
    Temperature = st.text_input("Temperatura (en graus kelvin)")
    ...
    st.text("[DE 4.5 a 5.499] ÉS UNA ESTRELLA HIPERGEGANT")
    st.text(
        "-----------------------------------------------------------------------------")
